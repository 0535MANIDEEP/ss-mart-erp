...
class BillingReady extends BillingState {
  ...
  final Map<String, SchemeResult> schemeResults;
  ...
  BillingReady copyWith({
    ...
    String? rateType,
    Map<String, SchemeResult>? schemeResults,
  ...
  List<Object> get props => [
        ...
        billDiscountPercent, billDiscountAmount, rateType,
        schemeResults.length, discountResult ?? 0,
      ];
}
